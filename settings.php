<?php
	$adresa="3756 Bonita Beach Rd.Bonita Springs, FL"; //jako je vazno navesti dobro adresu radi boljeg poziciniranja
	$grad="";//jako je vazno ako adresa ima dva imena povezati ih sa plus
	$skracenica=""; // AKo ne znate skracenicu ostavite praznu
	$telephone=2399924040;// Broj koji se poziva na dugme CALL US
